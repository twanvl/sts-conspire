...
import conspire.powers.TemporaryConfusionPower;

public class SneckoGhost extends AbstractMonster {
    public static final String ID = "conspire:SneckoGhost";
    ...
    public SneckoGhost(float x, float y) {
        ...
        this.loadAnimation("conspire/images/monsters/SneckoGhost/skeleton.atlas", "conspire/images/monsters/SneckoGhost/skeleton.json", 1.0f);
