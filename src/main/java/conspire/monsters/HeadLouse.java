...
public class HeadLouse extends AbstractMonster {
    public static final String ID = "conspire:HeadLouse";
    public static final String ENCOUNTER_NAME = "conspire:Head Lice";
    ...
    public HeadLouse(float x, float y) {
        ...
        this.loadAnimation("conspire/images/monsters/HeadLouse/skeleton.atlas", "conspire/images/monsters/HeadLouse/skeleton.json", 1.0f);
