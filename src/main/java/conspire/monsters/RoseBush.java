...
public class RoseBush extends AbstractMonster {
    public static final String ID = "conspire:RoseBush";
    public static final String ENCOUNTER_NAME = "conspire:RoseBush";
    public static final String DOUBLE_ENCOUNTER_NAME = "conspire:2 RoseBushes";
    ...
    public RoseBush(float x, float y, RoseColor color) {
        ...
        this.color = color;
        this.loadAnimation(atlasFile(color), "conspire/images/monsters/RoseBush/skeleton.json", 1.0f);
    ...
    private static String atlasFile(RoseColor c) {
        switch (c) {
            case RED:    return "conspire/images/monsters/RoseBush/skeletonR.atlas";
            case WHITE:  return "conspire/images/monsters/RoseBush/skeletonW.atlas";
            case YELLOW: return "conspire/images/monsters/RoseBush/skeletonY.atlas";
        }
        return "";
    }
