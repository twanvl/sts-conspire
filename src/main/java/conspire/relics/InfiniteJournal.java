...
public class InfiniteJournal extends AbstractConspireRelic {
    public static final String ID = "conspire:InfiniteJournal";
    ...
    private static void upgradeCardAgain(AbstractCard c) {
        ...
        if (oldMagicNumber > 0 && c.baseMagicNumber <= 0) {
            // Note: some cards decrease magicNumber, we probably don't want it to go at or below 0, for instance
