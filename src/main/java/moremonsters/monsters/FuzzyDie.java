...
import moremonsters.powers.CapriciousPower;

public class FuzzyDie extends AbstractMonster {
    public static final String ID = "FuzzyDie";
    public static final String ENCOUNTER_NAME = "FuzzyDice";
    ...
    public FuzzyDie(float x, float y) {
        ...
        this.loadAnimation("images/monsters/FuzzyDie/skeleton.atlas", "images/monsters/FuzzyDie/skeleton.json", 1.0f);
