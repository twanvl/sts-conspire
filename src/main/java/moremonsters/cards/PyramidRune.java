...
public class PyramidRune extends CustomCard {
    public static final String ID = "PyramidRune";
    ...
    public PyramidRune() {
        super(ID, NAME, "images/cards/"+ID+".png", COST, DESCRIPTION, CardType.STATUS, CardColor.COLORLESS, CardRarity.COMMON, CardTarget.SELF);
        this.exhaust = true;
        this.retain = true;
    }
